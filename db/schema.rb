...
ActiveRecord::Schema.define(version: 2023_02_26_123904) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.datetime "term_and_condition_accepted_at"
    t.integer "question_choice_type"
    t.string "commute_distance"
    t.integer "preconditioning_type"
    t.string "comfort_level"
    t.string "electric_vehicle_break"
    t.string "other"
    t.boolean "blocked", default: false
    t.integer "sign_in_count", default: 0
    t.datetime "blocked_now"
  end
  ...
  create_table "accounts_groups", force: :cascade do |t|
    t.bigint "account_id"
    t.bigint "group_id"
  ...
  create_table "battery_percentages", force: :cascade do |t|
    t.bigint "account_id"
    t.float "percent"
    t.string "grade"
    t.integer "status"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "late_charge", default: false
    t.index ["account_id"], name: "index_battery_percentages_on_account_id"
  end
  ...
  create_table "broadcasts", force: :cascade do |t|
    ...
    t.string "message"
    t.integer "account_ids", default: [], array: true
    t.string "jid"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "car_years", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["car_model_id"], name: "index_car_years_on_car_model_id"
  end
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "state_id"
    t.index ["state_code", "name"], name: "index_cities_on_state_code_and_name", unique: true
  end
  ...
  create_table "custom_ads", force: :cascade do |t|
    t.string "title"
  ...
  create_table "easy_modes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_easy_modes_on_account_id"
  end
  ...
  create_table "notification_reminder_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_notification_reminder_settings_on_account_id"
  end
  ...
  create_table "preview_videos", force: :cascade do |t|
    t.text "description"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "video_url"
  ...
  create_table "privacy_policies", force: :cascade do |t|
    ...
    t.datetime "start_date", default: "2023-02-28 10:59:23"
    t.datetime "end_date", default: "2024-02-28 10:59:23"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "states", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["country_code", "name"], name: "index_states_on_country_code_and_name", unique: true
  end
  ...
  create_table "user_badges", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_user_badges_on_account_id"
  ...
  create_table "vacation_mode_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_vacation_mode_settings_on_account_id"
  end
  ...
  create_table "zipcodes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["grid_type", "code"], name: "index_zipcodes_on_grid_type_and_code", unique: true
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "black_list_users", "accounts"
  add_foreign_key "car_models", "car_makes"
  add_foreign_key "car_years", "car_models"
  ...
  add_foreign_key "easy_modes", "accounts"
  ...
  add_foreign_key "notification_reminder_settings", "accounts"
  ...
  add_foreign_key "user_badges", "accounts"
  ...
  add_foreign_key "vacation_mode_settings", "accounts"
end
